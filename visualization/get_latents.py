...
# chair_a = "a6420c4ed13cf628945a77b945b7b70f"
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Generate latents for given hashes.")
    parser.add_argument("hashes", nargs="+", help="Hash values for which to generate latents.")
